...
public class GameView extends JPanel implements ActionListener{
	...
	private void init() throws Exception{
		...
		images[2] = ImageIO.read(new java.io.File("resources/spider_down.png"));
		images[3] = ImageIO.read(new java.io.File("resources/spider_up.png"));
		images[4] = ImageIO.read(new java.io.File("resources/ladder.png"));
		images[5] = ImageIO.read(new java.io.File("resources/zombie.png"));
		images[6] = ImageIO.read(new java.io.File("resources/visited.png"));
